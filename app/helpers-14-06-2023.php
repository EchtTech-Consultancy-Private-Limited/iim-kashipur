...
//photo gallery section
        ...
        $value=DB::table('photo_galleries')->where('link_category',$id)->join('quick_links', 'quick_links.link_option', '=', 'photo_galleries.id')->take(3)->get();  //two table data show karna ka leya
        return @$value ;
        }
 ...
 function  GEtvideo(){
  ...
  $value=DB::table('video_galleries')->where('link_category',$id)->join('quick_links', 'quick_links.link_option', '=', 'video_galleries.id')->take(3)->get();  //two table data show karna ka leya
  return @$value ;
  }
...
//footer section 8
        ...
        return Array('0'=>'Default','1'=>'Board of Governors','2'=>'Directer Profile','3'=>'Faculties Directory','4'=>'visiting faculity','5'=>'International Relations Team','6'=>'Partnerships_Collaborations','7'=>'TESTIMONIALS','8'=>'Master_Page' );
        }
