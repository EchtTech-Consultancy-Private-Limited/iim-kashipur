...
public function search(Request $request)
{
    ...
    $search=$request->search;
       $data=OrganisationStructure::where("title","like","%$search%")
                        ->orwhere("email","like","%$search%")
                        ->orwhere("designation","like","%$search%")
                        ->orwhere("phone","like","%$search%")
                        ->orwhere("description","like","%$search%")
                        ->get();   //org member table

        $data=anti_raggings::where("title","like","%$search%")->get();
                                                 //anti raggings

        $data=banner_sliders::where("title","like","%$search%")
                        ->orwhere("short","like","%$search%")
                        ->orwhere("heading1","like","%$search%")
                        ->get();  //banner

        $data=Career::where("name_of_the_post","like","%$search%")
                        ->orwhere("detail_advertisement","like","%$search%")
                        ->orwhere("corrigendum","like","%$search%")
                        ->orwhere("note","like","%$search%")
                        ->get();   //Career

        $data=cell_multiple_image::where("event","like","%$search%")
                     ->get();   //Cell image

        $data=cell::where("title","like","%$search%")
                ->orwhere("about_details","like","%$search%")
                ->orwhere("activites","like","%$search%")
                ->orwhere("	event","like","%$search%")
                ->get();   //Cell

        $data=club::where("title","like","%$search%")
                ->orwhere("about_details","like","%$search%")
                ->orwhere("event","like","%$search%")
                ->get();   //club

        $data=club_multiple_image::where("event","like","%$search%")
                    ->orwhere("about_details","like","%$search%")
                    ->orwhere("activites","like","%$search%")
                    ->orwhere("	event","like","%$search%")
                    ->get();   //club_multiple_images

        $data=commmittees::where("title","like","%$search%")
                ->orwhere("about_details","like","%$search%")
                ->orwhere("activites","like","%$search%")
                ->orwhere("	event","like","%$search%")
                ->get();   //commmittees

        $data=committee_multiple_images::where("committee_title","like","%$search%")
        ->orwhere("event","like","%$search%")
        ->get();   //committee_multiple_images


        $data=content_pages::where("name","like","%$search%")
        ...
        $data=Industry::where("title","like","%$search%")
        ->get();  //Industry

        $data=journal_publication::where("title","like","%$search%")
        ->get();  //journal_publication


        $data=journal_publication_child::where("about_details	","like","%$search%")
        ->get();  //journal_publication_child

        $data=multiple_profile::where("Title","like","%$search%")
                 ->orwhere("heading","like","%$search%")
                 ->orwhere("description","like","%$search%")
                 ->get();  //multiple_profile


        $data=news_event::where("title","like","%$search%")
             ->get();  //news_event

        $data=orgs::where("	name","like","%$search%")
        ...
        $data=org_journies::where("title","like","%$search%")
                    ->orwhere("heading","like","%$search%")
                    ->get();  //news_event
        ...
        $data=press_media::where("heading","like","%$search%")
        ...
        $data=project_logo::where("name","like","%$search%")
        ...
        $data=quick_linkcategory::where("Section","like","%$search%")
        ...
        $data=QuickLink::where("title","like","%$search%")
                      ->orwhere("short","like","%$search%")
                      ->get();   //QuickLink
        ...
        $data=student_profile::where("name","like","%$search%")
        ...
        $data=video_gallerie::where("name","like","%$search%")
                    ->orwhere("content","like","%$search%")
                      ->get();   //video_gallerie

        $data=wellness_facilities::where("about_details","like","%$search%")
                       ->orwhere("description","like","%$search%")
...
public function sub_childInnerpage($main_slug,$slug,$subchild,$superchild)  //content page superchild menu
{
    ...
    }elseif(OrganisationStructure::whereslug($superchild)->count())
    {
    ...
    }elseif(club::whereslug($superchild)->count()){    //club single
    ...
    elseif(commmittee::whereslug($superchild)->count()){    //commitee single
    ...
    }elseif(cell::whereslug($superchild)->count()){    //cell single
...
public function Child_barInnerpage($main_slug,$Sub_slug,$slug)
{
