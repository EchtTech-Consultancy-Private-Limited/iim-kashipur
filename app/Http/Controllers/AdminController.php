...
//ajax value call ---------------------------------------------------------------
    ...
    public function individualPageLIst()
    {
        $pages = App\Models\IndividualContentPage::all();
        return view('admin.pages.individual-pages-list', compact('pages'));
    }

    public function individualPageCreate()
    {
        return view('admin.pages.individual-pages-create');
    }

    public function individualPageStore(Request $request)
    {
        ...
        $e = new App\Models\IndividualContentPage;
        $destinationPath = "";
        ...
        // Save the page URL in the new page_link column
        $e->page_link = url('/individual-page/page?params=' . $e->slug);
        // Assuming 'page_link' is the name of the new column

        // Process PDF file upload
        if ($request->hasFile('pdf')) {
            $pdf = $request->file('pdf');
            $filename = time() . $pdf->getClientOriginalName();
            $pdf->move('page/pdf', $filename);
            $e->pdfsize = $pdf->getSize();
        ...
        // Return success response or redirect to appropriate page
        return redirect()->route('admin.individual-pages')->with('success', 'Page Created Successfully');

    }

    public function individualPageSEdit($id)
    {
        $id = dDecrypt($id);
        $data = App\Models\IndividualContentPage::find($id);
        return view('admin.pages.individual-pages-edit', compact('data'));
    }

    public function individualPageUpdate(Request $request, $id)
    {
        ...
        $u = App\Models\IndividualContentPage::find(dDecrypt($id));
        $u->name = $request->name;
        ...
        $u->page_link = url('/individual-page/page?params=' . $u->slug);
