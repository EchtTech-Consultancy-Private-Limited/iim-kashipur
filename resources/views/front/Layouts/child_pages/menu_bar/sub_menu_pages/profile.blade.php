...
<div class="internalpagebanner">
            @if(GetOrganisationAllDetails('default_banner_image')!='')
                <img src="{{asset('uploads/site-logo/'.GetOrganisationAllDetails('default_banner_image'))}}" style="height:auto;  min-height:200px; max-height:500px overflow:hidden;"  alt="{{ $type[0]->name ?? '' }}" title="{{ $type[0]->name ?? '' }}">
            @else
                <img src="{{ asset('assets/images/banners/board-of-governer-banner.jpg') ?? ''}}" style="height:auto;  min-height:200px; max-height:500px overflow:hidden;"   alt="{{ $type[0]->name ?? '' }}" title="{{ $type[0]->name ?? '' }}">
            @endif
       ...
       <div class="tab-section">
        <ul class="nav nav-tabs d-none d-lg-flex" id="myTab" role="tablist">
            ...
            <li class="nav-item " role="presentation">
                <button  @if($key == '0' ) class="nav-link active"  @else  class="nav-link" @endif  id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane{{ $key }}" type="button" role="tab" aria-controls="profile-tab-pane" >{{ $datas->Title }}</button>
             </li>
            @endforeach
        </ul>
        ...
        <div class="tab-content accordion" id="myTabContent">
            <div   @if($key == '0' ) class="tab-pane fade accordion-item active show"  @else  class="tab-pane fade accordion-item" @endif    id="profile-tab-pane{{ $key }}" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
