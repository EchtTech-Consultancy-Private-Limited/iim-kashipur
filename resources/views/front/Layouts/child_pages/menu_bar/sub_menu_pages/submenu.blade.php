            ...
            <div class="internalpagebanner">
                ...
                <div class="imagecaption">
                    ...
                    <div class="container">
                        ...
                        <h1>@if(GetLang()=='en') {{ $item[0]->name ?? '' }} @else {{ $item[0]->name_h ?? '' }} @endif</h1>
                ...
                <div class="container">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:void(0);"> @if(GetLang()=='en') {{ @$mmenu[0]->name  ?? ''}} @else {{ @$mmenu[0]->name_h  ?? ''}} @endif</a></li>
                         ...
                         <li><span> @if(GetLang()=='en') {{ $item[0]->name ?? ''}} @else {{ $item[0]->name_h ?? ''}} @endif </span></li>
                ...
                <div class="sidebarwraper">
                   ...
                   @endforeach
                        ...
                        <div class="col-md-9">
                                ...
                                <h3><span> @if(GetLang()=='en') {{ $items->name ?? '' }} @else {{ $items->name_h ?? '' }} @endif</span></h3>
                                        @if($items->cover_image!='' && $items->cover_image!='default.jpg')
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class=" top text-center mt-0">
                                                        <div class="profile-img">
                                                            <img src="{{asset('page/image/'.$items->cover_image)}}" alt="{{ $items->cover_alt }}" title="{{ $items->cover_title }}">
                                                        </div>
                                                ...
                                                <div class="col-md-7 col-lg-8">
                                                    ...
                                                    <p>  @if(GetLang()=='en') {!! $items->content !!} @else {!! $items->content_h !!} @endif</p>
                                                </div>
                                        @else
                                            <div class="commontxt">
                                                <div class="row">
                                                ...
                                                <div class="col-md-13 col-lg-12">
                                                    ...
                                                    @if(GetLang()=='en') {!! $items->content !!} @else {!! $items->content_h !!} @endif
