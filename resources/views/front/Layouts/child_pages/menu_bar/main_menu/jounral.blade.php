    ...
    <div class="breadcrumbs">
        <div class="container">
            <ul>
                ...
                <li><a href="{{ url()->previous() }}"><span> Research</span></a></li>
                        ...
                        <div class="innerpagecontent">
                            ...
                            @foreach ($item as $items)
                                <div class="mb-3">
                                    ...
                                    <b> URL </b> <a href="{{ url($items->url) }}" target="_blank">{{ $items->url }}</a>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col master-class">
                        <div class="innerpagecontent">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($item as $items)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    @if ($items->external == '1') onclick="return confirm('Are you sure  external window open?')"  target="_blank" href="{{ url($items->publishing_link) ?? '' }}"  @else href="{{ url($items->publishing_link) ?? '' }}" @endif>
                                                    Read More </a>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <p>Please use the following media and public relations contacts for inquiries by the media only.
                                Journalists on deadline are advised to contact by phone rather than email.</p>
