                ...
                <div class="col-md-9">
                    ...
                    @unless (count($item))
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <form role="form" method="get" action="{{ url('/faculty/faculty-directory') }}">
                                    <label>Area</label>
                                    <select name="dp" class="form-control" style="padding:10px 15px 9px ">
                                        <option value="">Any</option>
                                        @foreach ($departments as $k => $v)
                                            <option value="{{ $v->id }}"
                                                {{ $v->id == request('dp') ? 'selected' : '' }}>{{ $v->dept_name }}
                                            </option>
                                        @endforeach
                                    </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="d-flex">
                                    <input type="text" class="form-control"
                                        ...
                                        name="nd">
                                    <button type="submit" class="btn-info submit-btn-apply" tabindex="0">Apply</button>
                                </div>
                            </div>
