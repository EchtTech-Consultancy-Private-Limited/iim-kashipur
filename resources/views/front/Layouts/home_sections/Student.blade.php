               ...
               <div class="col-md-4">
                   <div class="event-card aos-init aos-animate" data-aos="fade-up" data-aos-duration="3000">
                       ...
                       <div class="myslider">
                           ...
                           <div class="marquee">
                               <div class="event-body item  marquee--inner pt-0">
                                           ...
                                           <div class="marquee-content">
                                               <div class="event-content notice-body" >
                                                   <a @if ($Ms->external == 'yes') @if (GetLang() == 'en')
                                                       onclick="return confirm('This link will take you to an external
                                                       web site.')" @else onclick="return confirm('यह लिंक आपको एक बाहरी
                                                       वेब साइट पर ले जाएगा।')" @endif
                                                       href="{{ $Ms->url }}"
                                                       ...
                                                       <div class="btn-wrap ">
                                                           <a @if ($Ms->external == 'yes') @if (GetLang() == 'en')
                                                               onclick="return confirm('This link will take you to an
                                                               external web site.')" @else onclick="return confirm('यह
                                                               लिंक आपको एक बाहरी वेब साइट पर ले जाएगा।')" @endif
                                                               href="{{ $Ms->url }}"
                                                               @elseif($Ms->external == 'no')
                                                               href="{{ url($Ms->url) }}" @endif
                                                               class="red-link">
                                                               @lang('common.READ_MORE') <img
                                                                   src="assets/images/read-more.svg" alt="read-more"
                                                                   class="img-fluid">
                                                           </a>
                                                       </div>
                                                   </a>
