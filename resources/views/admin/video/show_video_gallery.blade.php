                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($value->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/' . dEncrypt($value->id) . '/video_galleries') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/' . dEncrypt($value->id) . '/video_galleries') }}"
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('/Accounts/update_videoget/' . dEncrypt($value->id)) }}"
                                                            ...
                                                            <a href="{{ url('/Accounts/delete_vidoegallery/' . dEncrypt($value->id)) }}"
                                                                onclick="return confirm('Are you sure to edit this record?')"><i
