                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <td>
                            @if(@checkRoute('StatusChange'))
                                @if($value->status==1) <a href="{{url('Accounts/status-change/0/'.dEncrypt($value->id).'/video_galleries')}}" style="color:green;">Active</a> @else <a href="{{url('Accounts/status-change/1/'.dEncrypt($value->id).'/video_galleries')}}" style="color:red;">Inactive</a> @endif
                            @else
