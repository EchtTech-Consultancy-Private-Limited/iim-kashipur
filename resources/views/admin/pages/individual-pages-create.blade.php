...
@section('title', 'Manage Individual Content Page')
@section('content')
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">{{ 'Add Individual Content Page' }}</h4>
                            ...
                            @if (Session::has('error'))
                                ...
                                <form class="forms-sample row col-md-12" id="regForm" method="POST"
                                      action="{{ route('admin.store.individual-pages') }}" enctype="multipart/form-data">
                                    @csrf
