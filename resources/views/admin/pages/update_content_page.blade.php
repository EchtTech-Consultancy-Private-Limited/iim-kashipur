              ...
              <div class="card">
                ...
                <div class="card-body">
                 ...
                 @endif
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{ url('/Accounts/update_page_act'."/".dEncrypt($data->id)) }}"  enctype="multipart/form-data">
                ...
                <label for="inputText" class="col-sm-2 col-form-label">Banner Photo</label>
                  ...
                  <img src="{{ asset('page/banner/'.$data->banner_image)}}" width="150" height="100"/>
                ...
                <label for="inputText" class="col-sm-2 col-form-label">Content Photo</label>
                  ...
                  <img src="{{ asset('page/image/'.$data->cover_image)}}" width="150" height="100"/>
                ...
                <div class="col-md-12">
                    ...
                    <label for="inputText" class="col-sm-2 col-form-label">Archive_range</label>
                      ...
                      <input type="date" class="form-control" name="delete_range"  value="{{$data->delete_range}}"><br>
