                ...
                <div class="card-body">
                 ...
                 @endif
                  ...
                  @endif
                    ...
                    <div class="col-md-6">
                        <div class="form-group"> <label for="form_name"> Name *</label> <input id="form_name" type="text" value="{{$data->name}}" name="name" class="form-control special_no" placeholder="Please enter name *" required="required" data-error="Firstname is required."> </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group"> <label for="mobile"> Mobile *</label> <input id="mobile" type="text" value="{{$data->mobile}}" name="mobile" class="form-control" placeholder="Please enter mobile no *" maxlength="10" required="required" >
