                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                @if(@checkRoute('Admin_StatusChange'))
                                  @if($D->status == 1)

                                    <a href="{{url('Accounts/change-status/0').'/'.dEncrypt($D->id)}}"><span class="badge rounded-pill bg-success">Active</span></a>
                                ...
                                @else
                                  @if($D->status == 1) <span class="badge rounded-pill bg-success">Active</span> @else <span class="badge rounded-pill bg-danger">In Active</span> @endif

                                @endif
                              </td>
                              <td>
                              @if(@checkRoute('Assign_Roles'))
