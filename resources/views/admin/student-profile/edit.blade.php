                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample row col-md-12" method="POST" id="regForm"
                                action="{{ url('/Accounts/update-student-profile/' . dEncrypt($student->id)) }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="batch" required>
                                            ...
                                            <option value="1" {{ $student->batch == 1 ? 'selected' : '' }}>PhD 2021-25
                                                Batch Profile</option>
                                            <option value="2" {{ $student->batch == 2 ? 'selected' : '' }}>PhD 2020-24
                                                Batch Profile</option>
                                            <option value="3" {{ $student->batch == 3 ? 'selected' : '' }}>PhD 2019-23
                                                Batch Profile</option>
                                            <option value="4" {{ $student->batch == 4 ? 'selected' : '' }}>FPM 2018-22
                                                Batch Profile</option>
                                            <option value="5" {{ $student->batch == 5 ? 'selected' : '' }}>FPM 2017-21
                                                Batch Profile</option>
                                            <option value="6" {{ $student->batch == 6 ? 'selected' : '' }}>FPM 2016-20
                                                Batch Profile</option>
                                            <option value="7" {{ $student->batch == 7 ? 'selected' : '' }}>FPM 2015-19
                                                Batch Profile</option>
                                            <option value="8" {{ $student->batch == 8 ? 'selected' : '' }}>PhD 2022-26
                                                Batch Profile</option>
                                        </select>
                                        @error('batch')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control"name="area_specialization"
                                            placeholder="Area of Specialization"
                                            value="{{ $student->area_specialization }}"><br>
                       ...
                       --}}
                                        <textarea class="form-control" id="educational_background" name="educational_background" rows="4"
                                            placeholder="Educational background">{{ $student->educational_background }}</textarea>
                                        <div class="col-md-12">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" id="work_experience" name="work_experience" rows="4"
                                            placeholder="Work Experience">{{ $student->work_experience }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" id="papers_publications" name="papers_publications" rows="4"
                                            placeholder="Papers Publications">{{ $student->papers_publications }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" id="research_interests" name="research_interests" rows="4"
                                            placeholder="Research Interests">{{ $student->research_interests }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="file" class="form-control" name="student_image"
                                            value="{{ old('student_image') }}"><br>
                                        @if ($student->student_image)
                                            <img src="{{ asset('uploads/' . $student->student_image) }}" alt=""
                                                title="" style="height: 100px;  width: 100px;">
                                        @endif
                                    </div><br>
                                </div>
                                ...
                                <input type="submit" class="btn btn-primary" onclick="load();"
