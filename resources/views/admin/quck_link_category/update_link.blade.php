                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{ url('/Accounts/update_linkpost/'.dEncrypt($data->id))}}" >
                   ...
                   @csrf
                      ...
                      <div class="col-md-6">
                        ...
                        <option value="section10"{{$data->placement=='section10'?'selected':''}}>section(Footer3)</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="form_name" type="text" name="title"  class="form-control" placeholder="Please enter title *" value={{$data->Section}} required > </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <input id="form_name" type="text" name="Section_h"  class="form-control" placeholder="Please enter title *"  value={{$data->Section_h}} required > </div>
                    ...
                    <div class="form-group"> <label for="form_name">Short Note[hindi]</label>
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="form-group"> <label for="form_name">Sort Order*</label>
                       ...
                       <input id="form_name" type="text" name="sort_order"  class="form-control" placeholder="Please enter  sort_order*" required> </div>
