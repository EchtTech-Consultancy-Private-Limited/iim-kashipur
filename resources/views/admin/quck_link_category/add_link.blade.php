           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                 ...
                 @endif
                  ...
                  <form class="forms-sample row col-md-12" method="POST"  id="regForm"  action="{{url('/Accounts/add_link_action')}}" >
            ...
            <div class="col-md-6">
                ...
                <div class="form-group"> <label for="title">Title*</label>
                     ...
                     <input id="title" type="text" name="title"  class="form-control" placeholder="Please enter title *" value="{{ old('title') }}" >
            ...
            <div class="col-md-6">
                ...
                <div class="form-group"> <label for="Section_h">Title[Hindi]*</label>
                    ...
                    <input id="Section_h" type="text" name="Section_h"  class="form-control" placeholder="Please enter title *"  value="{{ old('Section_h') }}"  required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group"> <label for="link"  required >Placement*</label>
                          ...
                          <div class="form-group"> <label for="form_name">Short Note[Hindi]</label>
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="form-group"> <label for="form_name"> Sort Order*</label>
                             ...
                             <input id="form_name" type="number" name="sort_order"  class="form-control" placeholder="Please enter  sort_order*"  value="{{ old('sort_order') }}" required> </div>
                      ...
                      <select id="status"   class="form-control" aria-label="Default select example" name="status"><br>
