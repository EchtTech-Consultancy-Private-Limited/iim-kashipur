                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="top-menu-button">
                                ...
                                <p class="card-title">Manage Report </p>

                                <div>

                                    <button type="button" class="btn btn-primary"><a
                                            href="{{ url('/Accounts/add-edit-report') }}">Add New Report                                    </a></button>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $K => $D)
                                                    <tr>
                                                     ...
                                                     <td>
                                                        <a   href="{{url('uploads/report/'.$D->pdf)}}" download>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($D->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/' . dEncrypt($D->id) . '/reports') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/' . dEncrypt($D->id) . '/reports') }}"
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('Accounts/add-edit-report/'.dEncrypt($D->id)) }}"><i
                                                            ...
                                                            <a href="{{ url('Accounts/delete-report/'.dEncrypt($D->id)) }}"
