           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                @endif
                    ...
                    @csrf
                  <div class="col-md-12">
                    <div class="form-group"> <label for="urlcategory">Quick Link Section [Select from Dropdown]*</label>
                      <select name="urlcategory" class="form-control hide_url news_board_main" id="hide_url">
                        <option value="">Please Select</option>
                          @foreach($value as $DD)
                          <option value="{{$DD->id}}"  @if($id) @if($data->link_category == $DD->id) selected @endif @endif > {{($DD->Section)}} </option>
                          @endforeach
                      </select>
                    ...
                    <div class="col-md-12" id="@if(isset($data->news_type)) @if(!empty($data->news_type)) @else news_board @endif @endif">
                  ...
                  <div class="form-group"><label> Link Option  </label> &nbsp;
                    ...
                    <select  class="form-control" name="link" id="countries"  >
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group"> <label for="title">Name[English] *</label> <input id="title" type="text" name="title" @if($id) value="{{$data->title}}" @else value="{{old('title')}}" @endif class="form-control" placeholder="Please enter title *"  >
                ...
                <div class="form-group"> <label for="title_h">Name[Hindi] </label> <input id="title_h" type="text" name="title_h" @if($id) value="{{$data->title_h}}" @else value="{{old('title_h')}}" @endif class="form-control" placeholder="Please enter title hindi*"  >
                    ...
                    <label for="title_h"  id="title_h-error" class="error">
                       ...
                       <div class="form-group"> <label for="form_name">Short Note[English]</label> <input id="form_name2" type="text" name="short" @if($id) value="{{$data->short}}" @else value="{{old('short')}}" @endif class="form-control" placeholder="Please enter short note"  > </div>
                       ...
                       <div class="form-group"> <label for="form_name">Short Note[Hindi]</label> <input id="form_name3" type="text" name="short_h" @if($id) value="{{$data->short_h}}" @else value="{{old('short_h')}}" @endif class="form-control" placeholder="Please enter short note hindi"  > </div>
                       ...
                       <div class="col-md-6" >
                          ...
                          <div class="form-group"> <label for="sort_order">Sort Order</label> <input  id="sort_order" type="text" name="sort_order" @if($id) value="{{$data->sort_order}}" @else value="{{old('sort_order')}}" @endif class="form-control" placeholder="Please enter sort order"  >
                    ...
                    <div class="col-md-6" >
                        ...
                        <div class="form-group"> <label for="Image_Title">Image Title*</label> <input id="Image_Title" type="text" name="Image_Title" @if($id) value="{{$data->Image_Title}}" @else value="{{old('Image_Title')}}" @endif class="form-control" placeholder="Please enter Image Title"  >
                    ...
                    <div class="col-md-6" >
                        ...
                        <div class="form-group"> <label for="Image_Alt">Image Alt*</label> <input id="Image_Alt" type="text" name="Image_Alt" @if($id) value="{{$data->Image_Alt}}" @else value="{{old('Image_Alt')}}" @endif class="form-control" placeholder="Please enter Image Alt"  >
                        ...
                        <input  type="hidden" name="slug" @if($id) value="{{$data->slug}}" @else value="{{old('slug')}}" @endif class="form-control" >
