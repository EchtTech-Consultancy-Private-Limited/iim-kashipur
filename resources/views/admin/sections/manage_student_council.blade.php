...
@section('title', 'Manage Student Council ')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="top-menu-button">
                                ...
                                <p class="card-title">Manage Student Council </p>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($D->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/'.dEncrypt($D->id) . '/student_councils') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/'.dEncrypt($D->id) . '/student_councils') }}"
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('Accounts/add-edit-Student-Council/' . dEncrypt($D->id)) }}"><i
