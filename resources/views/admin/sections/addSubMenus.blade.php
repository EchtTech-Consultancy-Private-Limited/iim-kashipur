                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if ($id)
                                ...
                                @else
                                    <form class="forms-sample row col-md-12" method="POST" id="regForm"
                                        action="{{ url('Accounts/add-edit-sub-menu') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group"> <label for="form_name">Name[Hindi] *</label> <input id="form_name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label> Link Option </label> &nbsp;
                                    <select class="form-control" name="sub_id" id="countries" required>
