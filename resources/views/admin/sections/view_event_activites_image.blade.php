                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="">
                                   @if ($id) <img src="{{ asset('uploads/multiple/event_image/'.$event->image) }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="image_title"
                                        placeholder="Please enter" readonly value="{{ $event->image_title }}" ><br>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="image_alt"
                                        placeholder="Please enter" readonly  value="{{ $event->image_alt }}" ><br>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="">
                                    ...
                                    value="{{ $event->order }}" readonly placeholder="Please enter" value=""><br>
