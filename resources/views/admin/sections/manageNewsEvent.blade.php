...
@section('title', 'Manage News & Event ')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="top-menu-button">
                                ...
                                <p class="card-title">Manage News & Event </p>

                                <div>

                                    <button type="button" class="btn btn-primary"><a
                                            href="{{ url('/Accounts/add-news-edit-org') }}">Add New News & Event </a></button>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $K => $D)
                                                    <tr>
                                                       ...
                                                       <td><img src="{{ asset('uploads/news_event/' . $D->image) }}"
                                                                alt="" title=""
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('Accounts/add-news-edit-org/' . dEncrypt($D->id)) }}"><i
