...
@section('title', 'Manage ADD Banner Slider  ')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage Banners & Sliders </p>
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>@if($D->image != null || $D->image!='')<img class="thumb" src=  "{{asset('/banner/'.$D->image)}}" data-toggle="modal" data-target="#exampleModal" rel="{{$D->image}}" onclick="abc('{{$D->image}}')">
