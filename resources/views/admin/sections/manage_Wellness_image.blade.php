            ...
            <div class="row">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Manage Wellness Images</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($item->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/' . dEncrypt($item->id) . '/wellness_facilitie_images') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/' . dEncrypt($item->id) . '/wellness_facilitie_images') }}"
              ...
              //  alert(UserName);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#form').attr('action', '{{ url('Accounts/edit-Wellness-image') }}' +
                            '/' + data.item.id)
