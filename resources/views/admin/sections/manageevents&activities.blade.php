                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="top-menu-button">
                                ...
                                <p class="card-title">Events & Activites</p>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($D->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/' . dEncrypt($D->id) . '/events&activities') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/' . dEncrypt($D->id) . '/events&activities') }}"
