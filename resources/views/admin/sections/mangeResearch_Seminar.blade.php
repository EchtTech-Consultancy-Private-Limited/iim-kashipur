...
@section('title', 'Manage Research Seminar')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="top-menu-button">
                                ...
                                <p class="card-title">Manage Research Seminar</p>

                                <div>

                                    <button type="button" class="btn btn-primary"><a
                                            href="{{ url('/Accounts/add-edit-research-seminar') }}">Add New Research Seminar                                       </a></button>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $K => $D)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('Accounts/add-edit-research-seminar/'.dEncrypt($D->id)) }}"><i
                                                            ...
                                                            <a href="{{ url('Accounts/delete-research-seminar/'.dEncrypt($D->id)) }}"
