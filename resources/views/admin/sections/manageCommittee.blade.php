                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="top-menu-button">
                                ...
                                <p class="card-title">Manage Committee </p>

                                <div>

                                    <button type="button" class="btn btn-primary"><a
                                            href="{{ url('/Accounts/add-edit-committee') }}">Add New Committee </a></button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($D->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/'.dEncrypt($D->id).'/commmittees') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/'.dEncrypt($D->id).'/commmittees') }}"
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('Accounts/add-edit-committee/' . dEncrypt($D->id)) }}"><i
                                                                    class="ti-pencil btn-icon-append"
                                                                    style="color:black;"></i></a> &nbsp;


                                                                    <a
                                                                    href="{{ url('Accounts/view-Committee/' . dEncrypt($D->id)) }}"><i
                                                                        class="ti-eye btn-icon-append"
                                                                        style="color:black;"></i></a> &nbsp;


                                                            <a href="{{ url('Accounts/delete-committee/' . dEncrypt($D->id)) }}"
