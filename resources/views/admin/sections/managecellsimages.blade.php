            ...
            <div class="row">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Manage Cells Images</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (@checkRoute('StatusChange'))
                                                                @if ($item->status == 1)
                                                                    <a href="{{ url('Accounts/status-change/0/' . dEncrypt($item->id) . '/cell_multiple_images') }}"
                                                                        style="color:green;">Active</a>
                                                                @else
                                                                    <a href="{{ url('Accounts/status-change/1/' . dEncrypt($item->id) . '/cell_multiple_images') }}"
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-primary"
                                                                href="{{ url('Accounts/cells-images-delete/' . dEncrypt($item->id)) }}"
            ...
            <div class="modal-dialog modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-0">
                        ...
                        <form role="form" id="regForm" action="{{ url('Accounts/add-cells-image') }}" method="post"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="col-md-12">
                    <label for="event" class="col-form-label">Events</label>
                    <div class="">
                        <textarea class="form-control event" readonly id="event" rows="4" name="event" placeholder="Please enter event"></textarea><br>
        ...
        <script>
            $(document).on("click", "#update", function() {
              ...
              //  alert(UserName);
                ...
                $.ajax({
                    url: "{{ url('/Accounts/gallery_id_image') }}",
                    type: "get",
                    data: {
                        id: UserName
                    },
                    success: function(data) {
                        ...
                        $('#form').attr('action', '{{ url('Accounts/edit-cells-image') }}' +
                            '/' + data.item.id)
