           ...
           <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                @if($id)
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{url('Accounts/add-edit-child-menu/'.$id)}}" enctype="multipart/form-data">

                @else

                  <form class="forms-sample row col-md-12" method="POST" id="regForm" action="{{url('Accounts/add-edit-child-menu')}}" enctype="multipart/form-data">
                ...
                @endif
                    ...
                    <div class="col-md-6"   >
                     ...
                     <div class="form-group"><label> Sub Menu  </label> &nbsp;
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group"> <label for="name">Name *</label> <input id="name" type="text" name="name" @if($id) value="{{$data->name}}" @else value="{{old('name')}}" @endif class="form-control" placeholder="Please enter name *" required="required" >
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group"> <label for="name_h">Name[Hindi] *</label> <input id="name_h" type="text" name="name_h" @if($id) value="{{$data->name_h}}" @else value="{{old('name_h')}}" @endif class="form-control" placeholder="Please enter name *" required="required" >
                    ...
                    <div class="col-md-6">
                      ...
                      <input  type="text" name="sort_order"  class="form-control" placeholder="Please enter name *" required="required" value="{{$data->sort_order}}" required="required" >
                      ...
                      <div class="col-md-12"  >
                        <div class="form-group"> <label for="form_name">
                            ...
                            <select name="url" id="url" class="form-control"  @if($data->external=='yes') style="display:none;" @else style="display:block;" @endif required="required">
                                <option selected disabled value="" >Please Select</option>
