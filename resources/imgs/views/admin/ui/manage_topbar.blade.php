...
@section('title', 'Manage Headers Layout')
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-title">Manage Headers Layout</p>

                  <div>

                      <button type="button" class="btn btn-primary" ><a href="{{route('admin.addtopbar')}}">Add New Header Layout</a></button>
