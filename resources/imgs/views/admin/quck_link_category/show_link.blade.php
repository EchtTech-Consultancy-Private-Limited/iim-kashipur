            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <td>@if($value->status==1) <a href="{{url('Accounts/status-change/0/'.dEncrypt($value->id).'/quick_linkcategories')}}" style="color:green;">Active</a> @else <a href="{{url('Accounts/status-change/1/'.dEncrypt($value->id).'/quick_linkcategories')}}" style="color:red;">Inactive</a> @endif</td>
