...
@endif 
                  ...
                  <form class="forms-sample row col-md-12" method="POST" action="{{url('/Accounts/addaction_gallery')}}"  enctype="multipart/form-data">
                    @csrf
                ...
                <label for="inputText" class="col-sm-2 col-form-label">Content Photo</label>
                  <div class="col-sm-10">
                    <input type="file" class="form-control" name="imagename" accept=".jpeg,.png,.gif,.jpg"  placeholder="Please browse content image" accept=".jpeg,.jpg,.gif,.png"><br>
                ...
                <div class="col-md-12">
                  ...
                  <input type="hidden" class="form-control" name="photo_slug" placeholder="Please enter slug" value="photo_slug"><br>
