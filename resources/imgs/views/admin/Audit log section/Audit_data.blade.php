              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                    <form  action="{{url('/Accounts/Audit-data-show-with-filter')}}" method="post"> 
                   @csrf
                   <div class="row input-daterange">

                   <div class="col-4">
                  <input type="date" name="start_date" id="from_date" class="form-control" placeholder="From Date" >
                  </div>

                 <div class="col-4">
                 <input type="date" name="end_date" id="to_date" class="form-control" placeholder="To Date" >
                 </div>
                <div class="col-2">
                ...
                <div  class="col-2">
                <a class="btn btn-warning" href="{{ url('/Accounts/file-export') }}">Export Action Event</a>
                </div>
                 </div>
                </form><br><br>
