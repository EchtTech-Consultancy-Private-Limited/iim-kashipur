                    ...
                    <div class="col-12">
                      ...
                      <div class="table-responsive">
                        ...
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <td><img src="{{ asset('page/banner/'.$value->banner_image)}}" alt="" title="" style="height: 100px;  width: 100px;"></td>
                           ...
                           <td>@if($value->status==1) <a href="{{url('Accounts/status-change/0/'.dEncrypt($value->id).'/content_pages')}}" style="color:green;">Active</a> @else <a href="{{url('Accounts/status-change/1/'.dEncrypt($value->id).'/content_pages')}}" style="color:red;">Inactive</a> @endif</td>



                          <td>

                          <button type="submit" class="btn btn-primary btn-sm"><a href= "{{ url('/Accounts/pages-list/'.$value->id)}}" > Add Sub page</a></button>
