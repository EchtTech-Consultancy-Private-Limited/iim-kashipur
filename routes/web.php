...
Route::get('ajax-Tedx',[menuFormController::class,'ajax_Tedx']);

//tedx url image
Route::get('tedx-image-delete/{id?}',[menuFormController::class,'deleteTedxImage']);
Route::post('add-tedx-image', [menuFormController::class, 'add_TedxImage']);
